...
class MainActivity3 : Activity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        newgame.setOnClickListener {
            ...
            //sets the image resource for the snake and adds it to the game board
            ...
            // Generating random coordinates for the initial position of the meat
            ...
            fun checkFoodCollision() {
                // Code to check collision between snake and food
            ...
            // Define a Runnable to update the game state periodically
            ...
            // Starting the game loop by posting the runnable to the handler
